module PDU (
    ...
    always @(*) begin
        is_pdu = (pdu_ctrl_cs == STATE_STEP_ENABLE || pdu_ctrl_cs == STATE_RUN_WAIT) ? BRIDGE_CPU : BRIDGE_PDU;
    end
    ...
    // STEP & RUN -------------------------------------------------------------------------------
    always @(*) begin
        cpu_global_en = (pdu_ctrl_cs == STATE_STEP_ENABLE || pdu_ctrl_cs == STATE_RUN_WAIT);
    end
